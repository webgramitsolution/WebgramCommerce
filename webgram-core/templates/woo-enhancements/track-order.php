...
<div class="<?php echo esc_attr( Helpers::css_class( 'track' ) ); ?>" data-wgc-track>
	<form class="<?php echo esc_attr( Helpers::css_class( 'track__form' ) ); ?>" data-wgc-track-form novalidate>
		<p class="<?php echo esc_attr( Helpers::css_class( 'field' ) ); ?>"><label for="wgc-track-order"><?php esc_html_e( 'Order number', 'webgram-core' ); ?></label><input id="wgc-track-order" type="text" name="order" inputmode="numeric" placeholder="12345" required></p>
		<p class="<?php echo esc_attr( Helpers::css_class( 'field' ) ); ?>"><label for="wgc-track-contact"><?php esc_html_e( 'Email or phone used at checkout', 'webgram-core' ); ?></label><input id="wgc-track-contact" type="text" name="contact" autocomplete="email" required></p>
		<p class="<?php echo esc_attr( Helpers::css_class( 'track__message' ) ); ?>" data-wgc-track-message aria-live="polite"></p>
