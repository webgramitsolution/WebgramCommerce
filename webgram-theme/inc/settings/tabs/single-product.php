			...
			'fields'      => [
				...
				'product_below_order'   => [
					...
					'items' => [
						...
						'cross_sells'     => __( 'Cross-sells (frequently bought together)', 'webgram' ),
				...
				'product_cross_sells_count' => [ 'label' => __( 'Cross-sells on the product page', 'webgram' ), 'type' => 'range', 'min' => 0, 'max' => 8, 'description' => __( 'Set under Linked Products on each product. 0 hides the row.', 'webgram' ) ],
