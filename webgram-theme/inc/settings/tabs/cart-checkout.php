	...
	'sections' => [
		'drawer' => [
			...
			'fields' => [
				...
				'cart_drawer_block_top'    => [ 'label' => __( 'HTML Block above the items', 'webgram' ), 'type' => 'html_block', 'show_if' => [ 'cart_drawer', '==', true ] ],
				'cart_drawer_block_bottom' => [ 'label' => __( 'HTML Block below the items', 'webgram' ), 'type' => 'html_block', 'show_if' => [ 'cart_drawer', '==', true ] ],
				'cart_drawer_empty_block'  => [ 'label' => __( 'HTML Block in the empty state', 'webgram' ), 'type' => 'html_block', 'show_if' => [ 'cart_drawer', '==', true ] ],
